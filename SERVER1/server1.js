...
mongoose.connect("mongodb://localhost:27017/bankDB1",{useNewUrlParser:true ,useUnifiedTopology:true});
...
eventEmitter.on("acquire critical section",() => {
  ...
  var mealId = item_id;
    var orderQuantity = item_quantity;
    setTimeout(() => {
      Account.findOne({_id:mealId},(err1,result1) => {
        ...
        else
        {
          ...
          {
            console.log("Not enough balance in the account");
          }
        }
      })
...
http.listen(3000, function() {
  console.log('Bank App Server ',selfServerId,' Listening On Port 3000');
});
