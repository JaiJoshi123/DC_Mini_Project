...
mongoose.connect("mongodb://localhost:27017/bankDB2",{useNewUrlParser:true ,useUnifiedTopology:true});
...
http.listen(4000, function() {
  console.log('Bank App Server ',selfServerId,' Listening On Port 4000');
});
